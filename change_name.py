...
if __name__=="__main__":
    ...
    src_path_dir = "/media/tuan/Daten/project/dataset/cityscapes/cityscapes/disparity/train_wrongname"
    dst_path_dir = "/media/tuan/Daten/project/dataset/cityscapes/cityscapes/disparity/train"
    ...
    for src_sub_path in glob.glob("{}/*".format(src_path_dir)):
        ...
        for src_img_path in glob.glob("{}/*".format(src_sub_path)):
            ...
            new_img_name = "_".join(img_name.split("_")[:-1]) + "_disparity.png"
